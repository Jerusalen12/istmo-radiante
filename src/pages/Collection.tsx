...
const categories = [
  {
    ...
    technique: "Bordado a mano con técnica de cadenilla, punto de cruz y relleno sobre terciopelo, toque de seda o tela rayon de primera calidad.",
  ...
  },
  {
    ...
    technique: "Confección artesanal con encajes, bordados y tela chifon. Cada refajo es una pieza de arte textil.",
  ...
  },
  {
    ...
    desc: "Complementa tu traje istmeño con accesorios artesanales que resaltan la tradición y el estilo único de la región.",
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          >
            <motion.div variants={fadeInUp} className="overflow-hidden rounded-lg shadow-elegant">
              <img
                src={cat.image}
                alt={`${cat.name} artesanales del Istmo de Tehuantepec - ${cat.tagline}`}
      ...
      <div className="container mx-auto px-4 text-center md:px-8">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
          ...
          <motion.p variants={fadeInUp} className="mx-auto mt-4 max-w-xl font-body text-muted-foreground">
            El toque final. Joyería y detalles que completan tu identidad istmeña. Pregunta por aretes, collares y tocados tradicionales.
          </motion.p>
          <motion.div variants={fadeInUp} className="mt-6">
            <WhatsAppButton productName="Accesorios istmeños" label="Ver accesorios disponibles" />
          </motion.div>
        </motion.div>
      </div>
    </section>
