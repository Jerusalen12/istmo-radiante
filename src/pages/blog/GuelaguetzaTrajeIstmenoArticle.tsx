...
const GuelaguetzaTrajeIstmenoArticle = () => (
  <React.Fragment>
    ...
    >
      ...
      <h2>El Istmo de Tehuantepec en la Guelaguetza</h2>
      <p>
      ...
      <h2>El papel del traje istmeño en la fiesta</h2>
      <p>
      ...
      <h2>Más que folclor: una declaración cultural</h2>
      <p>
      ...
      <h2>¿Cómo vivir la Guelaguetza?</h2>
      <p>
      ...
      <h2>Lleva un pedazo del Istmo contigo</h2>
      <p>
        En <strong>Flor Radiante</strong>, celebramos el mismo espíritu de la Guelaguetza: compartir lo mejor de nuestra tierra. Cada huipil, enagua y refajo que ofrecemos está hecho por artesanas del Istmo de Tehuantepec, las mismas manos que bordan los trajes que brillan en el cerro del Fortín. Si deseas una prenda artesanal que honre esta tradición, <strong>escríbenos y creamos juntos algo especial para ti</strong>.
      </p>
    </BlogArticleLayout>
  </React.Fragment>
);
