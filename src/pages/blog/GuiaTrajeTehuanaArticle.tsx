...
const GuiaTrajeTehuanaArticle = () => (
  <React.Fragment>
    ...
    <BlogArticleLayout
      ...
      //heroImage={heroImg}
      heroAlt="Mujer luciendo el traje de tehuana completo: huipil bordado, enagua y refajo en el Istmo de Tehuantepec"
      related={related}
    >
      <p>
      ...
      <h2>¿Qué es el traje de tehuana?</h2>
      <p>
      ...
      <h2>El Huipil: La pieza central</h2>
      <p>
      ...
      <h3>Tipos de huipil según la ocasión</h3>
      <ul>
      ...
      <h2>La Enagua: Vuelo y tradición</h2>
      <p>
      ...
      <h2>El Refajo: La base invisible</h2>
      <p>
      ...
      <h2>Accesorios que completan el traje</h2>
      <ul>
      ...
      <h2>¿Cómo se usa el traje en la actualidad?</h2>
      <p>
      ...
      <h2>¿Dónde comprar un traje de tehuana auténtico?</h2>
      <p>
