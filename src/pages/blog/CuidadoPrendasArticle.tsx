...
const CuidadoPrendasArticle = () => (
  <React.Fragment>
      ...
      customCTA={
        <div className="mt-12 rounded-lg bg-primary/10 p-6 text-center">
          <p className="font-display text-lg font-semibold text-foreground">
            ¿Necesitas ayuda con el cuidado de tu prenda?
          </p>
          <p className="mt-2 font-body text-muted-foreground">
            En Flor Radiante podemos asesorarte sobre el cuidado de tus prendas artesanales
            o conectarte con nuestras artesanas para servicios de restauración.
          </p>
          <div className="mt-4 flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <WhatsAppButton
              variant="inline"
              label="Consultar sobre restauración"
              message="Hola, leí la guía de cuidado de prendas artesanales y me gustaría recibir información sobre restauración o cuidado de mis prendas. ¿Podrían ayudarme?"
            />
          </div>
        </div>
      }
    >
      ...
      <div className="h-4" />
      <h2><strong>Lavado: la regla de oro</strong></h2>
      <div className="h-4" />
      <p>
      ...
      <div className="h-4" />
      <h2><strong>Restauración</strong></h2>
      <div className="h-4" />
      <p>
      ...
      <div className="h-4" />
      <h2><strong>Cuida tu herencia</strong></h2>
      <div className="h-4" />
      <p>
