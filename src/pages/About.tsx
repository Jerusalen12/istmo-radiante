...
const artisans = [
  { name: "Doña Karla", specialty: "Bordado de terciopelo", years: "5 años de experiencia", desc: "Maestra del bordado floral sobre terciopelo. Sus manos han creado cientos de huipiles que hoy son tesoros familiares en todo el Istmo." },
  { name: "Doña Rosa", specialty: "Cadenilla y punto de cruz", years: "5 años de experiencia", desc: "Especialista en la técnica de cadenilla, Esperanza plasma en cada puntada los diseños heredados de su abuela." },
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid items-center gap-12 md:grid-cols-2">
            <motion.img
              ...
              src={costura}
              alt="Artesana del Istmo bordando huipil tradicional con técnica zapoteca"
