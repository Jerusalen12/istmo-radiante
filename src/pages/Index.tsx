      ...
      <section className="relative flex min-h-[90vh] items-center overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-8">
          ...
          >
            ...
            <div className="h-1 w-12 bg-primary mt-4 mb-6" />
            <motion.h1 variants={fadeInUp} className="text-4xl md:text-5xl lg:text-6xl font-bold font-display text-primary-foreground leading-tight">
              Tu tienda de confianza en San Blas Atempa, Oaxaca
            </motion.h1>
            <div className="h-1 w-12 bg-primary mt-4 mb-6" />
            <motion.p variants={fadeInUp} className="mt-6 font-body text-base leading-relaxed text-cream/80 md:text-lg">
              Huipiles, trajes istmeños, enaguas, guayaberas, refajos, vestidos y joyería artesanal.  Ofrecemos personalización de colores, medidas y diseños. Enviamos a todo México. Descubre nuestro catálogo y personaliza la tuya.
            </motion.p>
