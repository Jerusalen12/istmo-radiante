...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/5219711234567?text=${encodeURIComponent(msg)}`, "_blank");
  };
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
              ...
              <motion.div variants={stagger} className="mt-6 space-y-6">
                ...
                <motion.div variants={fadeInUp} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-body text-sm text-muted-foreground">Lunes a Miercoles y viernes: 9:00 AM – 7:00 PM</p>
                    <p className="font-body text-sm text-muted-foreground">Jueves: 9:00 AM – 4:00 PM</p>
                    <p className="font-body text-sm text-muted-foreground">Sabado: 12:00 AM – 6:00 PM</p>
                  </div>
                </motion.div>
                <motion.div variants={fadeInUp} className="flex items-start gap-4">
              ...
              <motion.div variants={fadeInUp} className="mt-8">
                ...
                <div className="mt-3 flex gap-4">
                  <a href="https://www.facebook.com/share/1BvDkyXSrs/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 font-body text-sm text-muted-foreground transition-colors hover:text-primary">
